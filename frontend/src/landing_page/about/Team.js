        ...
        <div className="container">
            ...
            <div className="row p-3 text-muted" style={{ lineHeight: "1.8", fontSize: "1.2em" }}>
                ...
                <div className="col-6 p-3">
                    <p>Nithin bootstrapped and founded Tradexa in 2010 to overcome the
                    hurdles he faced during his decade long stint as a trader. Today,
                    Tradexa has changed the landscape of the Indian broking industry.</p>.
                    ...
                    <p>Connect on <a href="" style = {{textDecoration:"none"}}>Homepage</a> / <a href="" style={{textDecoration:"nones"}}>TradingQnA</a> /{" "}
